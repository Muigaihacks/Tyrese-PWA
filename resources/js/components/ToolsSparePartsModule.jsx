...
export default function ToolsSparePartsModule() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("/api/inventory/checkout", {
        ...form,
  ...
  return (
    <div className="p-6">
      <div className="flex items-center mb-4">
        <div className="w-8 h-8 bg-blue-400 rounded mr-4" />
        <h2 className="text-2xl font-bold text-gray-800">Tools & Spare Parts Management</h2>
      </div>
      
      <div className="mb-6">
        <span className="text-blue-600 font-semibold">Welcome</span>
        <span className="text-gray-700">
          {" "}to our Tools & Spare Parts tracking system! Select multiple tools and spare parts for checkout from Kibiku.
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold mb-4">Available Items at Kibiku</h3>
          {loading ? (
            <div>Loading...</div>
          ) : (
        ...
        {/* Selected Items & Form */}
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold mb-4">Selected Items & Checkout</h3>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white py-2 rounded font-semibold hover:bg-blue-700 transition disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
