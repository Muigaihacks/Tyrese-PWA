...
import { FaBox, FaWarehouse, FaMapMarkedAlt, FaUsers, FaBatteryHalf, FaTruck } from 'react-icons/fa';
...
const navItems = [
  ...
  { name: 'Battery', path: '/battery', icon: <FaBatteryHalf size={24} /> },
  { name: 'Crate Tracker', path: '/crate-tracker', icon: <FaTruck size={24} /> },
];
